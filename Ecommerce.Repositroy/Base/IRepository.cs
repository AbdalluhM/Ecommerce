...
namespace Ecommerce.Repositroy.Base
{
    ...
    public interface IRepository<T> where T : class
    {
        ...
        /// with option to disable dynamic filter (isactive only)
        /// <returns>   all. </returns>
        ///-------------------------------------------------------------------------------------------------
        ...
        ListPaged<T> PagedResult<TKey>( int take, int skip, Expression<Func<T, TKey>> keySelector, Expression<Func<T, bool>> predicate, string sortDirection = nameof(SortingDirection.ASC), bool disableFilter = false, params Expression<Func<T, object>> [] includeProperties );
        ...
        Task<ListPaged<T>> PagedResultAsync<TKey>( int take, int skip, Expression<Func<T, TKey>> keySelector, Expression<Func<T, bool>> predicate, string sortDirection = nameof(SortingDirection.ASC), params Expression<Func<T, object>> [] includeProperties );
        ///-------------------------------------------------------------------------------------------------
        ...
        Task RefreshEntityReferencesAsync(T entity);
