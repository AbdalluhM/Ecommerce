...
using Ecommerce.BLL.FilterBuilder.Generic;
using System;
...
namespace Ecommerce.BLL.FilterBuilder
{
    ...
    public static class Builder
    {
        ...
        //{"IsActive":{"operator":"contains","value":true}
        ...
        //{"Employee.EmployeeCountries[EmployeeId]":{"operator":"equals","value":2039}}
        ...
        private static Expression ProcessListStatement(ParameterExpression param, IFilterStatement statement)
        {
            ...
            string probNameLeft = basePropertyName.IndexOf(".") > -1 ? basePropertyName.Split('.')[0] : basePropertyName;
            ...
            var type = param.Type.GetProperty(probNameLeft).PropertyType;
            foreach (var prob in basePropertyName.Split('.').Skip(1))
            {
                type = type.GetProperty(prob).PropertyType;
            }
